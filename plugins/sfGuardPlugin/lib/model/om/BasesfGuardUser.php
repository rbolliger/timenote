...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserPeer';
	 ...
	 * related Hours from storage. If this sfGuardUser is new, it will return
		...
		if ($this->collHours === null) {
			if ($this->isNew()) {
			   $this->collHours = array();
				...
				$criteria->add(HourPeer::USER_ID, $this->id);
	 ...
	 */
	public function getHoursJoinTimenoteProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collHours === null) {
			if ($this->isNew()) {
				...
				$this->collHours = HourPeer::doSelectJoinTimenoteProject($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
