  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in TimenoteEntryPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related TimenoteEntry objects
			$c = new Criteria(TimenoteEntryPeer::DATABASE_NAME);
			
			$c->add(TimenoteEntryPeer::USER_ID, $obj->getId());
			$affectedRows += TimenoteEntryPeer::doDelete($c, $con);
