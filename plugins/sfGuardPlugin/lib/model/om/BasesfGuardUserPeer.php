  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in HourPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Hour objects
			$c = new Criteria(HourPeer::DATABASE_NAME);
			
			$c->add(HourPeer::USER_ID, $obj->getId());
			$affectedRows += HourPeer::doDelete($c, $con);
