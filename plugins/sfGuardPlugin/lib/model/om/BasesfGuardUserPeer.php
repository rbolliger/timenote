  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in TimenoteHourPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			...
			// invalidate objects in UserWorktimePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related TimenoteHour objects
			$c = new Criteria(TimenoteHourPeer::DATABASE_NAME);
			
			$c->add(TimenoteHourPeer::USER_ID, $obj->getId());
			$affectedRows += TimenoteHourPeer::doDelete($c, $con);
			...
			$c->add(sfGuardUserProfilePeer::CREATED_BY, $obj->getId());
			$affectedRows += sfGuardUserProfilePeer::doDelete($c, $con);

			// delete related UserWorktime objects
			$c = new Criteria(UserWorktimePeer::DATABASE_NAME);
			
			$c->add(UserWorktimePeer::USER_ID, $obj->getId());
			$affectedRows += UserWorktimePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
