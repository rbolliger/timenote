...
require 'lib/model/om/BaseTimenoteProjectPeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'timenote_project' table.
 *
 * 
 *
 ...
 */
abstract class BaseTimenoteProjectNestedSetPeer extends BaseTimenoteProjectPeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'timenote_project.LFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'timenote_project.RGT';
	 ...
	 *
	 * @param      TimenoteProject $node	Propel object for model
	 ...
	 * @return     TimenoteProject			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		return TimenoteProjectPeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      TimenoteProject $child	Propel object for child node
	 * @param      TimenoteProject $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 * @param      TimenoteProject $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      TimenoteProject $parent	Propel object for given parent node
	 * @param      TimenoteProject $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      TimenoteProject $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		TimenoteProjectPeer::insertAsParentOf(TimenoteProjectPeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      TimenoteProject $child	Propel object to become child node
	 * @param      TimenoteProject $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = TimenoteProjectPeer::retrieveRoot($scopeId, $con);
		if (TimenoteProjectPeer::getNumberOfChildren($root) == 1) {
			return TimenoteProjectPeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      TimenoteProject $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return TimenoteProjectPeer::deleteRoot($con);
		}
	 ...
	 * @param      TimenoteProject $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      TimenoteProject $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = TimenoteProjectPeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = TimenoteProjectPeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = TimenoteProjectPeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = TimenoteProjectPeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$key = TimenoteProjectPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($root = TimenoteProjectPeer::getInstanceFromPool($key))) {
				$root = new $cls();
				$root->hydrate($row);
			}

			$root->setLevel(0);
			TimenoteProjectPeer::hydrateDescendants($root, $stmt);
			TimenoteProjectPeer::addInstanceToPool($root);
	 ...
	 *
	 * @param      TimenoteProject $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return TimenoteProjectPeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return TimenoteProjectPeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return TimenoteProjectPeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = TimenoteProjectPeer::retrieveParent($node, $con);
		$siblings = TimenoteProjectPeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = TimenoteProjectPeer::doSelectOne($c, $con);
	...
	{
		$children = TimenoteProjectPeer::retrieveChildren($node);
	 ...
	 *
	 * @param      TimenoteProject $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      TimenoteProject $child	Propel object for node
	 * @param      TimenoteProject $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      TimenoteProject $node1		Propel object for node
	 * @param      TimenoteProject $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      TimenoteProject $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return TimenoteProjectPeer::isValid(TimenoteProjectPeer::retrieveParent($node, $con));
	}
	...
	{
		return TimenoteProjectPeer::isValid(TimenoteProjectPeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return TimenoteProjectPeer::isValid(TimenoteProjectPeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = TimenoteProjectPeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/TimenoteProject $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = TimenoteProjectPeer::retrieveByPK($node, $con);
	...
	protected static function hydrateDescendants(NodeObject $node, PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = TimenoteProjectPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($child = TimenoteProjectPeer::getInstanceFromPool($key))) {
				$child = new $cls();
				$child->hydrate($row);
			}
			...
			if ($child->hasChildren()) {
				$descendants = array_merge($descendants, TimenoteProjectPeer::hydrateDescendants($child, $stmt));
			} else {
			...
			TimenoteProjectPeer::addInstanceToPool($child);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(TimenoteProjectPeer::ID, $keys, Criteria::IN);

				$stmt = TimenoteProjectPeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = TimenoteProjectPeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = TimenoteProjectPeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      TimenoteProject $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(TimenoteProjectPeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(TimenoteProjectPeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
...
} // BaseTimenoteProjectNestedSetPeer
