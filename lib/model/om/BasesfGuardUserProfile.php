...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserProfilePeer';
	...
	public function setPercent($v)
	{
		...
		if ($this->percent !== $v) {
			$this->percent = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::PERCENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->percent = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
			$this->resetModified();
			...
			return $startcol + 11; // 11 = sfGuardUserProfilePeer::NUM_COLUMNS - sfGuardUserProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setPercent($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::PERCENT)) $criteria->add(sfGuardUserProfilePeer::PERCENT, $this->percent);
	 ...
	 * related Hours from storage. If this sfGuardUserProfile is new, it will return
		...
		if ($this->collHours === null) {
			if ($this->isNew()) {
			   $this->collHours = array();
				...
				$criteria->add(HourPeer::USER_PROFILE_VERSION, $this->version);
