...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Remember', 'FirstName', 'LastName', 'Email', 'Birthday', 'Sciper', 'CreatedBy', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'remember', 'firstName', 'lastName', 'email', 'birthday', 'sciper', 'createdBy', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::REMEMBER, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, self::BIRTHDAY, self::SCIPER, self::CREATED_BY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'remember', 'first_name', 'last_name', 'email', 'birthday', 'sciper', 'created_by', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Remember' => 2, 'FirstName' => 3, 'LastName' => 4, 'Email' => 5, 'Birthday' => 6, 'Sciper' => 7, 'CreatedBy' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'remember' => 2, 'firstName' => 3, 'lastName' => 4, 'email' => 5, 'birthday' => 6, 'sciper' => 7, 'createdBy' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::REMEMBER => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::EMAIL => 5, self::BIRTHDAY => 6, self::SCIPER => 7, self::CREATED_BY => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'remember' => 2, 'first_name' => 3, 'last_name' => 4, 'email' => 5, 'birthday' => 6, 'sciper' => 7, 'created_by' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
