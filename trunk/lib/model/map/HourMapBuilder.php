...
/**
 * This class adds structure of 'hour' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class HourMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(HourPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(HourPeer::TABLE_NAME);
		$tMap->setPhpName('Hour');
		$tMap->setClassname('Hour');
		...
		$tMap->addForeignKey('USER_PROFILE_VERSION', 'UserProfileVersion', 'INTEGER', 'sf_guard_user_profile', 'VERSION', true, null);
